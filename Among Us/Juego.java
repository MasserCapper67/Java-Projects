...
public class Juego {
    ...
    public void atacarTripulante() {
        if (numTripulantes > 0) {
            int eliminado = aleatorio(100, (numTripulantes + 100));
            while (eliminado == impostor.getIdentificador()) {
                eliminado = aleatorio(100, (numTripulantes + 100));
            }
            eliminado -= 100;
            ...
            eliminarTripulante(eliminado + 1);
    ...
    public void expulsarImpostor() {
        int posicionImpostor = impostor.getIdentificador() - 1;
        if (posicionImpostor >= 0 && posicionImpostor < numTripulantes) {
            for (int i = posicionImpostor; i < numTripulantes; i++) {
                tripulacion[i] = tripulacion[i + 1];
            }
